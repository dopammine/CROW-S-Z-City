...
SWEP.Instructions = "A heavy-duty pickaxe with a reinforced shaft, perfect for breaking rocks and minerals.\n\nLMB to attack.\nRMB to block."
SWEP.Category = "Weapons - Melee"

SWEP.Spawnable = true
SWEP.AdminOnly = false

SWEP.WorldModel = "models/octoteam/weapons/melee/w_me_pickaxe.mdl"
SWEP.WorldModelReal = "models/weapons/tfa_nmrih/v_me_bat_metal.mdl"
SWEP.WorldModelExchange = "models/octoteam/weapons/melee/w_me_pickaxe.mdl"
SWEP.ViewModel = ""
...
SWEP.weaponPos = Vector(0, 0.9, -0.5)
...
SWEP.DamagePrimary = 52
SWEP.DamageSecondary = 16

SWEP.PenetrationPrimary = 21
SWEP.PenetrationSecondary = 8
